...
<head>
    ...
    <style>
        ...
        .card-horas .btn-theme {
            background: #155e75;
            border-color: #155e75;
        }

        .card-horas .btn-theme:hover {
            background: #164e63;
            border-color: #164e63;
        }
...
<body>
    ...
    <main class="form-page">
        <header class="page-header">
            <h1 class="form-title mb-0">Control de Personal</h1>
        </header>
        ...
        <section class="container px-0">
            <div class="row g-4 justify-content-center">
                <div class="col-12 col-lg-6">
                    <div class="card form-card">
                        <div class="card-body p-4">
                            <h2 class="section-title mb-4">Empleado Tiempo Completo</h2>

                            <form action="objects/objetoPersonalCompleto.php" method="post">
                                <fieldset>
                                    <legend>Datos de Empleado</legend>

                                    <div class="mb-3">
                                        <label class="form-label" for="txt_CodigoEmpleado">Codigo de empleado:</label>
                                        <input class="form-control" type="text" id="txt_CodigoEmpleado" name="txt_CodigoEmpleado" required>
                                    </div>
                                    ...
                                    <div class="mb-0">
                                        <label class="form-label" for="num_SueldoBase">Sueldo base:</label>
                                        <input class="form-control" type="number" id="num_SueldoBase" name="num_SueldoBase" min="0" step="0.01" required>
                                    </div>
                                </fieldset>

                                <fieldset>
                                    <legend>Empleado Tiempo Completo</legend>

                                    <div class="mb-0">
                                        <label class="form-label" for="num_Bono">Bono:</label>
                                        <input class="form-control" type="number" id="num_Bono" name="num_Bono" min="0" step="0.01" required>
                                    </div>
                                </fieldset>

                                <button class="btn btn-theme" type="submit" name="btn_RegistrarTiempoCompleto">Registrar tiempo completo</button>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="card form-card card-horas">
                        <div class="card-body p-4">
                            <h2 class="section-title mb-4">Empleado Por Horas</h2>

                            <form action="objects/objetoPersonalHoras.php" method="post">
                                <fieldset>
                                    <legend>Datos de Empleado</legend>
                                ...
                                <fieldset>
                                    <legend>Empleado Por Horas</legend>
                                ...
                                <button class="btn btn-theme" type="submit" name="btn_RegistrarPorHoras">Registrar por horas</button>
                            </form>
                        </div>
                    </div>
                </div>
